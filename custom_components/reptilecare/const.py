...
SIGNAL_RUNTIME_EVENT: Final = f"{DOMAIN}_runtime_event"
...
FRONTEND_PANEL_COMPONENT: Final = "reptilecare-todays-care-panel"
FRONTEND_PANEL_URL_PATH: Final = "reptilecare-today"
